...
public class AnunciosActivity extends AppCompatActivity {
    ...
    private ProgressBar progressbarAnuncios;
    private  boolean filtEstado = false;
    private boolean resultado = false;
    private boolean liberaRegiao = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressbarAnuncios = findViewById(R.id.progressBarAnuncio);
        progressbarAnuncios.setVisibility(View.GONE);
    ...
    public class RecuperarAnuncios extends AsyncTask<String,Void,Boolean > {

        @Override
        protected void onPreExecute() {

            progressbarAnuncios.setVisibility(View.VISIBLE);
    ...
    public void filtrarPorEstado(View view) {
        ...
        if(liberaRegiao == true) {

            AlertDialog.Builder dialogEstado = new AlertDialog.Builder(this);
            dialogEstado.setTitle("Filtre por região");
            ...
            Toast.makeText(getApplicationContext(),"Aguarde o carregamento da página!", Toast.LENGTH_LONG).show();
        }
    ...
    public void filtrarPorCategoria(View view){
        ...
        if( filtrandoPorEstado == true ) {
            ...
            AlertDialog.Builder dialogEstado = new AlertDialog.Builder(this);
            dialogEstado.setTitle("Filtre por categoria");
